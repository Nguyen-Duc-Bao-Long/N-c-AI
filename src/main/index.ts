...
import {
  ...
  resetFatResourceRuntime
} from './resources/resourceRuntime'

import {
  registerResourceIpcHandlers
} from './resources/resourceIpc'
    ...
    async () => {
      ...
      */
      ...
      /*
        ...
        Resource runtime đã được initialize ở phía trên.

        Expose read-only Resource API cho Preload / Renderer.
      */
